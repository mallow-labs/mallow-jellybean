...
export const JELLYBEAN_MACHINE_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([240, 170, 43, 148, 110, 172, 77, 89]);

export function getJellybeanMachineDiscriminatorBytes(): ReadonlyUint8Array {
...
/** Gets the encoder for {@link JellybeanMachineArgs} account data. */
...
/** Gets the decoder for {@link JellybeanMachine} account data. */
...
/** Gets the codec for {@link JellybeanMachine} account data. */
