...
import { findUnclaimedPrizesPda, UnclaimedPrizesSeeds } from '../pdas';
import {
  getPrizeDecoder,
  getPrizeEncoder,
  type Prize,
...
export const UNCLAIMED_PRIZES_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([171, 187, 169, 217, 28, 112, 80, 133]);

export function getUnclaimedPrizesDiscriminatorBytes(): ReadonlyUint8Array {
...
/** Gets the encoder for {@link UnclaimedPrizesArgs} account data. */
...
/** Gets the decoder for {@link UnclaimedPrizes} account data. */
...
/** Gets the codec for {@link UnclaimedPrizes} account data. */
...
export function decodeUnclaimedPrizes<TAddress extends string = string>(
  ...
  Account<UnclaimedPrizes, TAddress> | MaybeAccount<UnclaimedPrizes, TAddress> {
