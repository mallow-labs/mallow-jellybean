...
export const ADD_CORE_ITEM_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  138, 200, 152, 167, 252, 149, 240, 114,
]);

export function getAddCoreItemDiscriminatorBytes(): ReadonlyUint8Array {
...
export function getAddCoreItemInstructionDataEncoder(): FixedSizeEncoder<AddCoreItemInstructionDataArgs> {
...
export function getAddCoreItemInstructionDataDecoder(): FixedSizeDecoder<AddCoreItemInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getAddCoreItemInstructionDataCodec(): FixedSizeCodec<
...
export type AddCoreItemAsyncInput<
...
export async function getAddCoreItemInstructionAsync<
  TAccountJellybeanMachine extends string,
  TAccountAuthorityPda extends string,
  TAccountAuthority extends string,
  TAccountPayer extends string,
