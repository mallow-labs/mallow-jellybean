...
export class LiteSVMConnection {
  ...
  // Shares the same underlying LiteSVM instance the kit client drives, so umi
  // scaffolding (mpl-core assets, gumball guards) and kit jellybean instructions
  // execute against one ledger.
  constructor(private readonly _svm: LiteSvm) {}
